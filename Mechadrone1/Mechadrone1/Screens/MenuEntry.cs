...
namespace Mechadrone1.Screens
{
    ...
    class MenuEntry
    {
        ...
        {
            return screen.ScreenManager.FontManager.LineSpacing(FontType.ArialMedium);
        }
        ...
        {
            return (int)screen.ScreenManager.FontManager.MeasureString(FontType.ArialMedium, Text).X;
        }
