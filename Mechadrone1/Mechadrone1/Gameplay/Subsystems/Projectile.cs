...
namespace Mechadrone1.Gameplay
{
    class Projectile
    {
        ...
        public bool Update(float elapsedTime)
        {
            ...
            int playerHit = gmOwner.GetPlayerAtPosition(position);
                ...
                normalizedTime == 1.0f)
            {
                ...
                if (animatedSpriteSize > 0)
                    gmOwner.AddAnimSprite(animatedSprite, explosionPosition, 
                ...
                if (explosionDamageRadius > 0)
                    gmOwner.AddDamageSplash(player, explosionDamage, 
                ...
                if (explosionSound != null)
                    gmOwner.PlaySound3D(explosionSound, explosionPosition);

                // add explosion particle system
                if (projectileType == ProjectileType.Missile)
                    gmOwner.AddParticleSystem(
