...
namespace Mechadrone1.Gameplay
{
    ...
    class AnimSpriteManager : IDisposable
    {
        VertexBuffer[] vertexBuffer;          // vertex buffer for each player with 
        // all running animated sprites
        VertexDeclaration vertexDeclaration;  // vertex declaration
        ...
        public void LoadContent(GraphicsDevice gd, ContentManager content)
        {
            ...
            vertexBuffer[0] = new VertexBuffer(gd, typeof(VertexPositionTexture), GameOptions.MaxSprites * 6, BufferUsage.WriteOnly);
            vertexBuffer[1] = new VertexBuffer(gd, typeof(VertexPositionTexture), GameOptions.MaxSprites * 6, BufferUsage.WriteOnly);
        }
