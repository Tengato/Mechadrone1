...
namespace Mechadrone1
{
    ...
    class ChaseCamera : ICamera
    {
        ...
        {
            get { return Matrix.CreatePerspectiveFieldOfView(FieldOfView, AspectRatio, 0.1f, 1000.0f); }
        }
        ...
        public Matrix Transform
        {
            get
            {
                return Matrix.CreateWorld(Position, LookAt - Position, Up);
            }
        }
        ...
        public void Update(float elapsedTime)
        {
            ...
            // TODO: P3: Use the physics sim to keep the camera in a valid location
