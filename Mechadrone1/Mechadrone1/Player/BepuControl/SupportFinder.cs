    ...
    public class SupportFinder
    {
        ...
        public void UpdateSupports()
        {
            ...
            if (!HasTraction && hadTraction)
            {
                ...
                //TODO: P4: could also require that the character has a nonzero movement direction in order to use a ray cast.  Questionable- would complicate the behavior on edges.
