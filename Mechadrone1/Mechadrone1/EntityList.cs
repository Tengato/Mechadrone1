...
namespace Mechadrone1
{
    public struct SGEntity
    {
        ...
        /// </summary>
        public SGEntity(string entityName, Matrix entityTransform)
        {
            name = entityName;
    ...
    {
        // entities list
        public List<SGEntity> entities = new List<SGEntity>();
        ...
        {
            foreach (SGEntity e in entities)
            {
                if (e.name == name)
                {
                    return e.transform;
